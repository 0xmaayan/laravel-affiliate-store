        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1000">
                    <img src="{{asset('images/home_slider/slider0.png')}}"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500" >
                    <img src="{{asset('images/home_slider/slider11.png')}}"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li data-transition="fadetotopfadefrombottom" data-slotamount="7" data-masterspeed="1000">
                    <img src="{{asset('images/home_slider/slider2.png')}}"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <div class="caption dark sfb fadeout" data-x="970" data-y="250" data-speed="400" data-start="800"  data-easing="Power4.easeOut">
                        ...
                        <a href="mailto:{{$settings['email']}}" class="caption-btn">JOIN NOW!</a>
                    </div>
                </li>
            </ul>
        </div>
