        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500" >
                    <img src="{{asset('images/home_slider/'.$contents[0]['files'][1])}}"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li data-transition="fadetotopfadefrombottom" data-slotamount="7" data-masterspeed="1000">
                    <img src="{{asset('images/home_slider/'.$contents[0]['files'][2])}}"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
