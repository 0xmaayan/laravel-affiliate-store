    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="col-md-9">
                ...
                <div class="form-group col-md-4">
                    <img class="card-img-top" style="width: 200px;height:200px;object-fit: contain;" src="{{asset('uploads/categories/'.$category->id.'/'.$category->files->second_image)}}" alt="category image">
                </div>
